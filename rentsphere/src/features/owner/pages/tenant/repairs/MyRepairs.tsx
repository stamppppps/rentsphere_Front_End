...
export default function MyRepairs() {
    ...
    const badge = (status?: string | null) => {
        ...
        const common = "text-xs font-black px-2 py-1 rounded-full border inline-flex items-center gap-1";
        ...
        if (s === "CANCELLED")
            return <span className={`${common} bg-rose-50 text-rose-700 border-rose-100`}>ยกเลิก/ปฏิเสธ</span>;
            ...
            <div className="max-w-3xl mx-auto">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex gap-2">
                        <button onClick={() => nav("/tenant/home")} className="bg-white font-bold px-4 py-2 rounded-xl">
                            กลับหน้าหลัก
                        </button>
