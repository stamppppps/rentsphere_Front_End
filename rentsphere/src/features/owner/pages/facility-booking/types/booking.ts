...
/**
 * Booking Status Enum
 * Represents every possible state of a booking in its lifecycle.
 */
...
/**
 * Interface representing a detailed Booking record.
 * Designed to hold comprehensive data so that the UI can explain the context 
 * of any status (e.g., why it was rejected, when they checked in).
 */
