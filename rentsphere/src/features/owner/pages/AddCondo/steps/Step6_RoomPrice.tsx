...
return (
  <div style={styles.content}>
    ...
    <div style={styles.footerBar}>
      {/* ✅ footer ก็ใช้ container เดียวกัน */}
      <div style={styles.container}>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  // ✅ เพิ่ม container กลางให้ใช้ร่วมกัน
  container: {
    width: "100%",
    maxWidth: 1120,
    margin: "0 auto",
  ...
  // ✅ centerCol ไม่ต้อง maxWidth/margin แล้ว ให้ใช้ container ครอบ
  centerCol: {
    display: "flex",
  ...
  // ✅ footerInner เอา padding 40 ออก เพื่อให้ตรงกับด้านบน
  footerInner: {
    display: "flex",
