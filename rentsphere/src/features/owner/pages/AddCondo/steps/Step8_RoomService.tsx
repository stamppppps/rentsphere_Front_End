...
export default function Step8_RoomService() {
    ...
    const getService = (id: string | null | undefined) => {
        if (!id) return null;
                    ...
                    <div className="relative w-[760px] max-w-[92vw] rounded-2xl bg-white shadow-[0_18px_50px_rgba(0,0,0,0.35)] overflow-hidden border border-blue-100/60">
                        ...
                        <div className="px-8 py-7">
                            ...
                            <select
                                ...
                                className="w-full h-14 rounded-2xl border border-gray-200 bg-white px-5 text-base font-extrabold text-gray-900 shadow-sm
                        ...
                        <div className="px-8 py-5 bg-white border-t border-blue-100/60 flex items-center justify-end gap-3">
                            <button
                                type="button"
                                onClick={() => setOpenModal(false)}
                                className="h-[46px] px-7 rounded-xl bg-white border border-gray-200 text-gray-800 font-extrabold text-sm shadow-sm hover:bg-gray-50 active:scale-[0.98] transition
                           focus:outline-none focus:ring-2 focus:ring-gray-200"
                            >
                                ปิด
                            </button>
                            ...
                            <button
                                ...
                                className="h-[46px] px-7 rounded-xl bg-white border border-rose-200 text-rose-700 font-extrabold text-sm shadow-sm hover:bg-rose-50 active:scale-[0.98] transition
                           focus:outline-none focus:ring-2 focus:ring-rose-200"
                            ...
                            <button
                                ...
                                className={[
                                    "h-[46px] px-8 rounded-xl border-0 text-white font-extrabold text-sm shadow-[0_12px_22px_rgba(0,0,0,0.18)] transition",
                                    "focus:outline-none focus:ring-2 focus:ring-blue-300",
                                    selectedService
