...
export default function AdminParcel() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      setErr(e.message || "Failed to submit parcel");
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="bg-white rounded-3xl border border-indigo-100 shadow-xl shadow-indigo-100/30 overflow-hidden">
            <div className="p-6 md:p-8">
              ...
              <div className="mt-6">
                ...
                <input ref={fileInputRef} type="file" accept="image/jpeg,image/png,image/webp" onChange={(e) => onPickFile(e.target.files?.[0] || null)} className="hidden" />
