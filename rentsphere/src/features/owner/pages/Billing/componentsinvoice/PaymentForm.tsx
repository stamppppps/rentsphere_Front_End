...
const PaymentForm: React.FC<PaymentFormProps> = ({
  ...
  const triggerDatePicker = (e: React.MouseEvent<HTMLButtonElement>) => {
    e.stopPropagation();
  ...
  const handleAmountChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setPaymentAmount(sanitizeAmount(e.target.value));
  };
      ...
      <div className="bg-white rounded-[32px] p-8 shadow-sm border border-gray-100 flex justify-between items-center">
        ...
        <div className="flex items-baseline">
          <span className="text-[#EF4444] text-3xl font-bold">
            {Number(estimatedTotal || 0).toLocaleString("th-TH", {
