    ...
    <div className="bg-white rounded-[32px] p-8 shadow-sm border border-gray-100">
      ...
      <div className="bg-[#F8FAFC] rounded-2xl p-4 flex items-center justify-between group">
        <div className="flex items-center gap-4 min-w-0">
          <div className="w-12 h-12 rounded-xl bg-[#DCFCE7] flex items-center justify-center text-[#22C55E] shrink-0">
          ...
          <div className="min-w-0">
            <div className="text-[#1E293B] font-bold text-base leading-tight">
              {formatMoney(amount)}
              <span className="text-gray-400 text-xs font-normal ml-1">บาท</span>
            </div>
        ...
        <button
          ...
          aria-label="ลบประวัติการรับเงิน"
        >
